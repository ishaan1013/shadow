...
export const metadata: Metadata = {
  title: "Shadow - AI-Powered Coding Agent",
  description: "Transform your ideas into production-ready code with an autonomous AI agent that writes, tests, and deploys your projects in real-time.",
};
